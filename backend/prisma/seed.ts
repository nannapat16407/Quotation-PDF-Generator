  ...
  const packagesData = [
    {
      ...
      descriptionTh: 'ระบบบริหารงานบุคคลเบื้องต้นสำหรับทีมเล็ก',
    ...
    },
    {
      ...
      description: 'Full HR suite for growing businesses',
      descriptionTh: 'ชุดระบบ HR ครบวงจรสำหรับธุรกิจที่กำลังเติบโต',
      billingType: 'MONTHLY' as const,
      monthlyPrice: 459,
      yearlyPrice: 4590,
      sortOrder: 2,
    },
    {
      ...
      name: 'Advanced',
      nameTh: 'แอดวานซ์',
      description: 'Advanced features for mid-size companies',
      descriptionTh: 'ฟีเจอร์ขั้นสูงสำหรับบริษัทขนาดกลาง',
      billingType: 'MONTHLY' as const,
      monthlyPrice: 859,
      yearlyPrice: 8590,
      sortOrder: 3,
    },
    {
      ...
      name: 'Go Pro',
      nameTh: 'โก๊ะโปร',
      description: 'Unlimited users, full platform access',
      descriptionTh: 'ผู้ใช้งานไม่จำกัด เข้าถึงแพลตฟอร์มเต็มรูปแบบ',
